import { PrerenderRoute, NitroConfig } from 'nitropack';
...
declare function nitro(options?: Options, nitroOptions?: NitroConfig): Plugin[];

export { type Options, type SitemapConfig, nitro as default };
