  ...
  if (matches) {
    ...
    for (const w of words()) {
      ...
      if (wordMatches) {
        ...
        console.log(dayjs().subtract(1, "days").format("YYYY-MM-DD HH:mm"))
        console.log(dayjs().subtract(1, "hours").format("YYYY-MM-DD HH:mm"))
        console.log(wordMatches,w.startAt.format("YYYY-MM-DD"))
